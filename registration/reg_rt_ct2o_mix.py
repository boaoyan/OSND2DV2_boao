...
def reg_ct2o_mix(img, standard_pose, volume_path, model_path):
    """
    ...
    label_transformer_mix = LabelTransformMix(noise_params)
    ...
    with torch.no_grad():
        ...
        pre_rota, pre_trans = label_transformer_mix.label2real(outputs)  # [1, 3], [1, 3]
        # outputs_new = model(img_new)
        # pre_rota_new, pre_trans_new = label_transformer_mix.label2real(outputs_new)
